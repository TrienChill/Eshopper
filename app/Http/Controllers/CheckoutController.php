...
{
    private $vnp_TmnCode  = "26B1DO7K";
    private $vnp_HashSecret   = "NQFESRMUSUBOKTEVNJIQAKPDGEJLDWON";
    private $vnp_Url   = "https://sandbox.vnpayment.vn/paymentv2/vpcpay.html";
    private $vnp_Returnurl   = "http://127.0.0.1:8000/checkout";
    ...
    public function store(Request $request)
    {
        ...
        else if(isset($request->payment) && $request->payment == 'vnpay')
        {
            ...
            $vnp_TmnCode = "26B1DO7K"; 
            $vnp_HashSecret = "NQFESRMUSUBOKTEVNJIQAKPDGEJLDWON"; 
        ...
        else if(isset($request->payment) && $request->payment == 'momo')
        {
            ...
            $response = \MoMoAIO::purchase([
                'amount' => $amount,
                'returnUrl' => 'http://127.0.0.1:8000/return-momo/',
                'notifyUrl' => 'http://127.0.0.1:8000/checkout/',
